module.exports.config = {
  ...
  description: "THIS BOT IS MADE BY SHANKAR SUMAN",
...
const fs = global.nodemodule["fs-extra"];
  ...
  var callback = () =>   api.sendMessage({body:`${name} 💞 ये लो आपका प्रोफाइल डी पी 💞`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
