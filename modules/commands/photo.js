...
module.exports.run = async function({ api, event, args }) {
    ...
    if(keySearch.includes("-") == false) return api.sendMessage('Please enter in the format, example: '+global.config.PREFIX+this.config.name+' naruto - 10', event.threadID, event.messageID)
