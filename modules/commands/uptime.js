...
module.exports.config = {
	...
	version: "1.0.0",
	hasPermssion: 0,
	credits: "Mirai-Team/Prince Sanel",
	description: "Uptime",
...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText(`${global.config.BOTNAME} BOT`, canvas.width / 2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("UNDER CLIFF VINCENT", canvas.width / 2 - 660, 1000);
